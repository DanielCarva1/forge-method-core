...
| Presentation/deck craft | deferred | Forge can support creative/story workflows, but pitch/deck production is not required for the current Codex-native method runtime. | Users repeatedly request launch/pitch/deck workflows as part of Forge projects. |
