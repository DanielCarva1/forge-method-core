...
| CIS presentation master | `presentation-craft` lens over `storytelling` | deferred/folded | Pitch and presentation narrative now route to `storytelling` with medium, outline, proof, and call-to-action fields; visual deck production remains outside current runtime scope. | Revisit a full deck workflow only if launch/pitch/deck production becomes explicit Forge scope. |
...
| `bmad-market-research` | `market-scan`, `artifact research-check` | translated |
| `bmad-domain-research` | `domain-scan`, `artifact research-check` | translated |
| `bmad-technical-research` | `technical-feasibility-scan`, `artifact research-check` | translated |
...
| `bmad-spec` | `write-spec`, `quick-dev`, `artifact spec-check` | translated |
...
| `/cis-agent-presentation-master` | `presentation-craft` Persona Lens over `storytelling`; deck production deferred | deferred/folded |
| `/bmgd-generate-project-context` | `game-context` | translated |
| `/bmgd-brainstorm-game` | `brainstorming`, `game-brief`, `game-context` | translated |
| `/bmgd-game-brief` | `game-brief`, `artifact game-check` | translated |
| `/bmgd-create-gdd` | `gdd` | translated |
| `/bmgd-create-architecture` | `engine-architecture`, `engine-setup` | translated |
| `/bmgd-sprint-planning` | `game-sprint-planning`, `game-story-creation`, `artifact game-check` | translated |
