...
purpose:
  Guide game-specific production work after the initial brief: UX, PRD, stories, sprint status, retrospective, and game testing.

open_floor:
  "What part of the game lifecycle is unclear right now: player experience, requirements, stories, sprint health, retrospective learning, or test proof?"

source_material:
  Ask for brief, GDD, references, prototype notes, engine/platform constraints, story files, playtest notes, and build evidence.
