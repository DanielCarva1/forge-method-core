...
const INDEPENDENT_REVIEW: &str =
    "contracts/evidence/workflow-agent-native-continuity-independent-review-v0.yaml";
const REVIEW_SIGNED_AT_UNIX: u64 = 1_784_037_600;
const SEMANTIC_SIGNATURE: &str =
    "7088b172ee44764ed93faf69e45d468eb34d0959e5cbee175234fb810f8cd06bdf4b0b8db04315a860367ed51326849ff97644e939286bb3ae54872bf39d980d";
const AUTHORIZER_SIGNATURE: &str =
    "84f85adec190355b7964959cb3e0262d5c67442179dda4449a798f870524aaf40cda10acc1789f0d3483270aaf314ca6e9b450d18affd581b34d8356e0d41409";
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if evaluation.status
        ...
        || evaluation.predecessor_policy_count != 33
        || evaluation.candidate_policy_count != 42
        || evaluation.reviewed_workflow_count != 9
...
fn parse_mode() -> Result<Mode, Box<dyn std::error::Error>> {
    ...
    match args.as_slice() {
        ...
        _ => Err("usage: cargo run -p forge-core-decisions --example generate_workflow_agent_native_continuity_admission -- (--write|--check)".into()),
    }
}
...
fn reviewer_registry() -> WorkflowReleaseReviewerRegistryDocument {
    WorkflowReleaseReviewerRegistryDocument {
        ...
        workflow_release_reviewer_registry: WorkflowReleaseReviewerRegistry {
            registry_id: id("workflow-release-reviewers.agent-native-continuity-v0"),
            registry_version: "0.3.0".to_owned(),
            authority: WorkflowReleaseReviewerRegistryAuthority::CandidateOnly,
            credentials: vec![
                WorkflowReleaseReviewerCredential {
                    credential_id: id(
                        "reviewer.workflow-release.semantic-agent-native-continuity-v0",
                    ),
                    principal_id: PrincipalId(
                        "principal.release-review.semantic-agent-native-continuity-v0".to_owned(),
                    ),
                    public_key_fingerprint:
                        "sha256:b9ae45b817df86b93c798d1dbccea5abfbb0caa9b7f5461ce1a43adc0ca1d643"
                            .to_owned(),
                    public_key_hex:
                        "c4feb901057a42b12705e64961ac312e8d79662a208385b1c97c174cab572403"
                            .to_owned(),
                ...
                WorkflowReleaseReviewerCredential {
                    credential_id: id(
                        "reviewer.workflow-release.authorizer-agent-native-continuity-v0",
                    ),
                    principal_id: PrincipalId(
                        "principal.release-review.authorizer-agent-native-continuity-v0".to_owned(),
                    ),
                    public_key_fingerprint:
                        "sha256:195369655ffcf6e5ef22190296015994f9cb206b1a766342856d90f769d50334"
                            .to_owned(),
                    public_key_hex:
                        "f7c6cca2e2cc5e4af9ce051d80dca12be2710699aeed4d1de0ac72ac154c7487"
                            .to_owned(),
                    algorithm: WorkflowReleaseAdmissionSignatureAlgorithm::Ed25519,
...
fn authorization(
    ...
    let payload = WorkflowReleaseAdmissionAuthorizationPayloadV2 {
        authorization_id: id("workflow-release-admission.agent-native-continuity-v0"),
        ...
        nonce: "release-admission.agent-native-continuity-v0".to_owned(),
...
fn fixture() -> WorkflowReleaseAdmissionCandidateV2Input {
    const COVERAGE: &str =
        "contracts/policies/workflow-behavioral-coverage-agent-native-continuity-v0.yaml";
    const CORPUS_SET: &str =
        "contracts/evidence/workflow-agent-native-continuity-corpus-set-v0.yaml";
    ...
    reject_crlf(&[
        "contracts/policies/workflow-agent-native-continuity-overlay-v0.yaml",
        COVERAGE,
        CORPUS_SET,
        REPRESENTATIVE,
        ADVERSARIAL,
    ...
    promoted_bundle.workflow_governance_bundle.id =
        id("bundle.workflow-governance.agent-native-continuity-v0");
    ...
    let proposed_registry_binding = WorkflowReleaseReviewArtifactBindingV2 {
        artifact_id: id("workflow-governance.registry.agent-native-continuity-v0"),
    ...
    let index = WorkflowReleaseReviewIndexV2Document {
        ...
        workflow_release_review_index: WorkflowReleaseReviewIndexV2 {
            id: id("workflow-release-review.agent-native-continuity-v0"),
            index_version: "0.3.0".to_owned(),
            ...
            release_manifest: binding(
                "release-manifest.agent-native-continuity-v0",
                MANIFEST,
                &manifest,
            ),
            ...
            review_subject: binding(
                "review-subject.agent-native-continuity-v0",
                SUBJECT,
                &subject,
            ),
            coverage_policy: binding(
                "coverage-policy.agent-native-continuity-v0",
                COVERAGE,
                &coverage,
            ),
            ...
            corpus_set: binding(
                "corpus-set.agent-native-continuity-v0",
                CORPUS_SET,
                &corpus_set,
            ),
            ...
            shadow_report: binding("shadow-report.agent-native-continuity-v0", REPORT, &report),
            candidate_runtime_bundle: binding(
                "runtime-bundle.agent-native-continuity-candidate-v0",
                CANDIDATE_BUNDLE,
                &candidate_bundle,
            ),
            promoted_runtime_bundle: promoted_bundle_binding,
            predecessor_registry: binding(
                "registry.assurance-operations-v0",
                PREDECESSOR_REGISTRY,
                &predecessor_registry,
            ),
            ...
            frozen_history: source_binding(
                "history.workflow-governance.assurance-operations-v0",
                HISTORY,
                history_bytes,
    ...
    WorkflowReleaseAdmissionCandidateV2Input {
        ...
        migration_batches: vec![golden_batch, core_batch, assurance_batch, continuity_batch],
        migration_plan,
        migration_audit,
        legacy_workflows,
