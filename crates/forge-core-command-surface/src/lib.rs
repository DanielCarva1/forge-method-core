...
pub const COMMAND_WORKFLOW: CommandSpec = CommandSpec {
    ...
    usage_lines: &[
        ...
        "       forge-core workflow episode prepare --root <path> [--json|--no-json]",
        ...
        "       forge-core workflow current-work prepare --root <path> [--operation <accept|supersede|checkpoint_quick_cycle>] [--json|--no-json]",
        ...
        "       forge-core workflow release-rebase-plan [--root <path>] --target-release-id <id> --expected-rebase-plan-digest <sha256> [--json|--no-json]",
...
pub const COMMAND_DOMAIN_PACK: CommandSpec = CommandSpec {
    ...
    usage_lines: &[
        ...
        "       forge-core domain-pack search --request-file <path> [--json|--no-json]",
