...
pub enum FamilyKind {
    ...
    DomainPackTrustPolicy,
    DomainPackSupplyChainRegistry,
    DomainPackRuntimeCapabilityRegistry,
    DomainPackCapabilitySandboxPolicy,
    DomainPackResolutionRequest,
    DomainPackResolutionProjection,
    DomainPackExactLock,
    DomainPackCompatibilityReport,
    DomainPackLifecycleRequest,
    DomainPackLifecyclePreflight,
