...
pub use assurance::{
    ...
    DurableAssuranceEpochBinding, DurableAssuranceLensProjection, DurableAssuranceProjection,
    DurableAssuranceReadinessState, HumanDecisionReason, IntentProposal, NextAction,
    NextActionKind, Obligation, ObligationCriticality, ObligationStatus, ProjectSnapshot,
    ReadinessAssessment, ReadinessTarget, ReadinessVerdict, UniversalAssuranceLens,
    WorkflowHumanIntentRevision, ASSURANCE_CASE_SCHEMA_VERSION,
...
pub use workflow_governance::{
    ...
    WaiverAuthorizedEvent, WorkflowCapabilityProbeKind, WorkflowCapabilityRequirement,
