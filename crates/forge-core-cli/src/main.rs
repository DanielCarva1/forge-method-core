...
fn main() {
    ...
    let result: Result<(), ExitError> = match command {
        ...
        "host-adapter-verify-fulcio-certificate-identity" => host_adapter_verify_cmd::run_host_adapter_verify_fulcio_certificate_identity_command(
            &args,
        ),
        ...
        "host-adapter-verify-sigstore-dsse-in-toto-subject" => host_adapter_verify_cmd::run_host_adapter_verify_sigstore_dsse_in_toto_subject_command(
            &args,
        ),
        "host-adapter-verify-sigstore-timestamp-authority" => host_adapter_verify_cmd::run_host_adapter_verify_sigstore_timestamp_authority_command(
            &args,
        ),
        "host-adapter-verify-certificate-transparency-sct" => host_adapter_verify_cmd::run_host_adapter_verify_certificate_transparency_sct_command(
            &args,
        ),
        "host-adapter-verify-certificate-revocation-policy" => host_adapter_verify_cmd::run_host_adapter_verify_certificate_revocation_policy_command(
            &args,
        ),
        "host-adapter-verify-tuf-trusted-root-freshness" => host_adapter_verify_cmd::run_host_adapter_verify_tuf_trusted_root_freshness_command(
            &args,
        ),
