...
pub const COMMANDS: &[CommandSpec] = &[
    ...
    CommandSpec::from_surface(&surface::COMMAND_DOMAIN_PACK, crate::domain_pack_cmd::run_domain_pack_command),
    ...
    CommandSpec::from_surface(&surface::COMMAND_BACKUP, crate::backup_cmd::run_backup_command),
    CommandSpec::from_surface(&surface::COMMAND_RESTORE, crate::restore_cmd::run_restore_command),
