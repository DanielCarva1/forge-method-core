...
pub const COMMANDS: &[CommandSpec] = &[
    ...
    CommandSpec {
        ...
        usage_lines: &["       forge-core execute-operation --root <path> --operation <path> [--command <path>] [--effect <path>] [--payload <target_ref>=<path>] [--max-payload-bytes <bytes>] [--allow-payload-outside-root] [--allow-bootstrap-core] [--recorded-at <value>] [--tx-id-prefix <value>] [--require-risk-audit <path>] [--require-citation] [--no-sync] [--json]"],
