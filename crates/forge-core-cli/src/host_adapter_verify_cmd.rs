...
use crate::cli_util::{next_arg, parse_i64, usage};
use crate::*;
use std::path::PathBuf;

pub fn run_host_adapter_verify_artifact_command(args: &[String]) {
...
pub fn run_host_adapter_verify_provenance_command(args: &[String]) {
    let mut artifact_path: Option<PathBuf> = None;
...
pub fn run_host_adapter_verify_rekor_entry_command(args: &[String]) {
...
pub fn run_host_adapter_verify_sigstore_trust_policy_command(args: &[String]) {
...
pub fn run_host_adapter_verify_fulcio_certificate_identity_command(args: &[String]) {
...
pub fn run_host_adapter_verify_sigstore_bundle_subject_command(args: &[String]) {
...
pub fn run_host_adapter_verify_sigstore_dsse_in_toto_subject_command(args: &[String]) {
    let mut bundle_path: Option<PathBuf> = None;
    let mut artifact_path: Option<PathBuf> = None;
    let mut trust_policy_path: Option<PathBuf> = None;
    let mut certificate_path: Option<PathBuf> = None;
...
pub fn run_host_adapter_verify_sigstore_timestamp_authority_command(args: &[String]) {
    let mut trust_policy_path: Option<PathBuf> = None;
    let mut certificate_path: Option<PathBuf> = None;
    let mut rekor_log_entry_path: Option<PathBuf> = None;
    let mut rekor_public_key_path: Option<PathBuf> = None;
...
pub fn run_host_adapter_verify_certificate_transparency_sct_command(args: &[String]) {
    let mut trust_policy_path: Option<PathBuf> = None;
    let mut certificate_path: Option<PathBuf> = None;
...
pub fn run_host_adapter_verify_certificate_revocation_policy_command(args: &[String]) {
    let mut trust_policy_path: Option<PathBuf> = None;
    let mut certificate_path: Option<PathBuf> = None;
...
pub fn run_host_adapter_verify_tuf_trusted_root_freshness_command(args: &[String]) {
    let mut trust_policy_path: Option<PathBuf> = None;
...
pub fn run_host_adapter_verify_certificate_crl_status_command(args: &[String]) {
    let mut trust_policy_path: Option<PathBuf> = None;
    let mut certificate_path: Option<PathBuf> = None;
...
pub fn run_host_adapter_verify_certificate_ocsp_status_command(args: &[String]) {
    let mut trust_policy_path: Option<PathBuf> = None;
    let mut certificate_path: Option<PathBuf> = None;
    let mut issuer_certificate_path: Option<PathBuf> = None;
