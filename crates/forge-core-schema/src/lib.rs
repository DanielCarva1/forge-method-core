use forge_core_contracts::{
    ...
    RuntimeHandoffContractDocument, RuntimeRegistryEntryDocument,
    SoloHostConformanceBundleManifest, SoloHostConformanceCorpusDocument,
    SoloHostConformanceRequestDocument, SoloHostConformanceResponseDocument,
    SoloHostConformanceResultDocument, ToolEffectContractDocument,
...
pub fn generated_contract_schemas() -> Vec<ContractSchemaArtifact> {
    vec![
        ...
        schema_artifact::<SoloHostConformanceCorpusDocument>(
            "solo_host_conformance_corpus",
            "SoloHostConformanceCorpusDocument",
            None,
            "public host-neutral eight-capability corpus; names do not create support",
        ),
        schema_artifact::<SoloHostConformanceRequestDocument>(
            "solo_host_conformance_request",
            "SoloHostConformanceRequestDocument",
            None,
            "versioned argv adapter request with exact environment bindings",
        ),
        schema_artifact::<SoloHostConformanceResponseDocument>(
            "solo_host_conformance_response",
            "SoloHostConformanceResponseDocument",
            None,
            "adapter observations and typed gaps; adapter cannot declare final outcomes",
        ),
        schema_artifact::<SoloHostConformanceResultDocument>(
            "solo_host_conformance_result",
            "SoloHostConformanceResultDocument",
            None,
            "Forge-derived per-capability outcomes; integrity alone is not authenticity",
        ),
        schema_artifact::<SoloHostConformanceBundleManifest>(
            "solo_host_conformance_bundle",
            "SoloHostConformanceBundleManifest",
            None,
            "closed deterministic bundle manifest with independently recalculated digests",
