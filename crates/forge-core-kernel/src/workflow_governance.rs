...
pub use retirement::{
    ...
    WORKFLOW_RETIREMENT_AUDIENCE, WORKFLOW_RETIREMENT_AUTHORIZATION_REF,
    WORKFLOW_RETIREMENT_AUTHORIZER_KEY_FINGERPRINT,
    WORKFLOW_RETIREMENT_CONSUMER_OBSERVED_UNTIL_UNIX,
    WORKFLOW_RETIREMENT_EVIDENCE_REVIEWER_KEY_FINGERPRINT,
    WORKFLOW_RETIREMENT_RELEASE_MANIFEST_REF, WORKFLOW_RETIREMENT_REVIEWER_REGISTRY_RAW_DIGEST,
    WORKFLOW_RETIREMENT_RUNTIME_BUNDLE_REF, WORKFLOW_RETIREMENT_RUNTIME_EVIDENCE_REF,
