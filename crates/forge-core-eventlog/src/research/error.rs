...
pub type ResearchAdmitError = crate::EventLogError<super::ResearchProjectionDiagnostic>;
...
pub type ResearchProjectionError = crate::EventLogError<super::ResearchProjectionDiagnostic>;
