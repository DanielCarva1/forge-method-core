...
pub type RecordError = crate::EventLogError<super::ArbitrationProjectionDiagnostic>;

/// Errors raised by [`crate::arbitrate::arbitrate`]. A denied arbitration is
/// [`crate::ArbitrateStatus::DeniedByGate`], not an error.
pub type ArbitrateError = crate::EventLogError<super::ArbitrationProjectionDiagnostic>;

/// Errors raised by [`crate::escalate::escalate`].
pub type EscalateError = crate::EventLogError<super::ArbitrationProjectionDiagnostic>;
...
pub type ArbitrationProjectionError = crate::EventLogError<super::ArbitrationProjectionDiagnostic>;
