...
use super::{ArbitrationProjectionDiagnostic, GovernanceDomain, GovernanceEvent, RecordError};
...
#[cfg(test)]
mod tests {
    use super::super::{project, GovernanceEvent, GOVERNANCE_LOG_RELATIVE_PATH};
    use super::*;
