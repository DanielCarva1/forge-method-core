...
pub type AdmitError = crate::EventLogError<super::MemoryProjectionDiagnostic>;

/// Errors raised by [`crate::promote::promote`]. A denied promotion is
/// [`crate::PromoteStatus::DeniedByGate`], not an error.
pub type PromoteError = crate::EventLogError<super::MemoryProjectionDiagnostic>;

/// Errors raised by [`crate::retention::forget`].
pub type ForgetError = crate::EventLogError<super::MemoryProjectionDiagnostic>;
...
/// `ClaimWalProjectionError::RecoveryStopped`). Only structural I/O / parse
/// failures are errors.
pub type MemoryProjectionError = crate::EventLogError<super::MemoryProjectionDiagnostic>;
