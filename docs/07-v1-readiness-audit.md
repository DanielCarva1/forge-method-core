...
| Distribution | The package validates as a Codex plugin, can be installed into a personal marketplace, and can also be cloned, installed locally as a skill fallback, validated, and published through a versioned release. | plugin validation, plugin-local smoke, `release check`, CI, GitHub release |
