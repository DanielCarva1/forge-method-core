...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\smoke-plugin-clone-install.ps1 -RepoUrl https://github.com/DanielCarva1/forge-method-core.git -Ref v1.27.0 -ExpectedVersion 1.27.0
```

```bash
REPO_URL=https://github.com/DanielCarva1/forge-method-core.git REF=v1.27.0 EXPECTED_VERSION=1.27.0 bash scripts/smoke-plugin-clone-install.sh
```
