...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\smoke-plugin-clone-install.ps1 -RepoUrl https://github.com/DanielCarva1/forge-method-core.git -Ref v1.31.1 -ExpectedVersion 1.31.1
```

```bash
REPO_URL=https://github.com/DanielCarva1/forge-method-core.git REF=v1.31.1 EXPECTED_VERSION=1.31.1 bash scripts/smoke-plugin-clone-install.sh
```
