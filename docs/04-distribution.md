...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\smoke-plugin-clone-install.ps1 -RepoUrl https://github.com/DanielCarva1/forge-method-core.git -Ref v2.0.5 -ExpectedVersion 2.0.5
```

```bash
REPO_URL=https://github.com/DanielCarva1/forge-method-core.git REF=v2.0.5 EXPECTED_VERSION=2.0.5 bash scripts/smoke-plugin-clone-install.sh
```
