...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\smoke-plugin-clone-install.ps1 -RepoUrl https://github.com/DanielCarva1/forge-method-core.git -Ref v2.0.4 -ExpectedVersion 2.0.4
```

```bash
REPO_URL=https://github.com/DanielCarva1/forge-method-core.git REF=v2.0.4 EXPECTED_VERSION=2.0.4 bash scripts/smoke-plugin-clone-install.sh
```
