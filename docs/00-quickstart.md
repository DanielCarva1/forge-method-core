...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\smoke-plugin-clone-install.ps1 -Ref v2.0.3 -ExpectedVersion 2.0.3
```

```bash
REF=v2.0.3 EXPECTED_VERSION=2.0.3 bash scripts/smoke-plugin-clone-install.sh
```
