...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\smoke-plugin-clone-install.ps1 -Ref v2.0.5 -ExpectedVersion 2.0.5
```

```bash
REF=v2.0.5 EXPECTED_VERSION=2.0.5 bash scripts/smoke-plugin-clone-install.sh
```
