...
**Próximo**: todas as features P1/P2/P3 fechadas (F05/F06/F07/F08/F12/F14 ✅). Resta apenas **R-FAST** (Rápido 9→10: profile hot paths + otimizações pontuais). Features comunidade agora 10/10.
...
| Features comunidade | 10 | 10 | F03/F04/F01/F02/F15 operacionais; **F11.1+F11.2+F11.3+F11.4 ✅**; **F13 ✅** `forge-core cost`; **F05 ✅** eval harness; **F06 ✅** memory policy (gates + PEP + CLI + E2E); **F07 ✅** multi-principal governance (PrincipalId + ConflictContract + arbitration ledger + CLI + E2E); **F08 ✅** secure MCP adapter (rmcp + Allowlist/MutateGate/Attestation + CLI + E2E); **F12 ✅** Guided Start (read-only state machine + fixtures + E2E); **F14 ✅** Knowledge Orchestration (citation check + evidence graph + research CLI + runtime gate + fixtures + E2E). Todas as features P1/P2/P3 fechadas |
