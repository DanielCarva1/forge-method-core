...
- destination: forge-method-core repo (DanielCarva1/forge-method-core) — local working copy at `<user-home>/OneDrive/Documentos/ody`
...
- **forge-standalone-app** (`<user-home>/OneDrive/Documentos/forge-standalone-app`, a Rust/Cargo project) consumes core contracts via `contracts/forge-method-core`. **Parity between Python core and Rust app must be maintained.**
